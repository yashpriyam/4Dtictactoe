 var TicTacToe4D = (function() {
    ...
    var S = 3; //side length
    var spaceBetweenBoards = S+0.1;     //along the w-axis
    var canvSel = '#canvas';
    ...
    var gameState = [];         //array literal, can't be overwritten unlike array object 'new Array()'
    var playerTurn = 0;
    ...
    function init4DTicTacToe() {
        ...
        for (var xi = 0; xi < S; xi++) {
            gameState.push([]);     //.push exists only for array literal not for array object
